...
from main import stitch_images, crop_content, stretch_to_360, set_gpano_metadata, fill_black_holes
...
def upload_file():
    ...
    success, result_or_msg = stitch_images_advanced(saved_paths)
    ...
    if success:
        ...
        if img is not None:
             ...
             # 2. Fill remaining internal holes/gaps with Smart Blur
             img = fill_black_holes(img)
             
             # 3. Force Stretch to 360 Ratio (2:1)
             img = stretch_to_360(img)
